...
class SignUpState extends State<SignUp> {
  ...
  void _handleSubmitted() {
    ...
    showDialog<int>(
        ...
        builder: (context) => new ShowAwait(_userLogUp(
      ...
      if (onValue == 0) {
        ...
        Navigator
            .of(context)
            .pop([_phoneController.text, _passwordController.text,_usernameController.text]);
      }
    });
  }
  ...
  Future<int> _userLogUp(String username, String password,
    ...
    return await http
        .post(
        "http://eevee.petpika.cn/soultalk/api/user/register",
        body: json.encode({ 'phone': int.parse(phone),'password': password,'username':username,'email':email})
