...
/// The state of a [Profile] which is used to control the style of the circle and
/// text.
///
/// See also:
///
...
class Profiler extends StatefulWidget {
  ...
  Profiler({
    Key key,
    @required this.steps,
    this.type: ProfileType.vertical,
    this.currentStep: 0,
    this.onStepTapped,
    this.onStepContinue,
    this.onStepCancel,
  ...
  @override
  _ProfilerState createState() => new _ProfilerState();
}

class _ProfilerState extends State<Profiler> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(Profiler oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.type) {
      case ProfileType.vertical:
        return _buildVertical();
      case ProfileType.horizontal:
